...
agent_config = PlayerAgentConfig(
    ...
    agent_wheel_path="/Users/akshayiyer/Desktop/MS CS Columbia/hackathons/werewolf-hackathon/src/werewolf_agents/simple_sample/dist/simplewolf-0.0.1-py3-none-any.whl", 
