...
agent_config = PlayerAgentConfig(
    ...
    agent_wheel_path="/Users/akshayiyer/Desktop/MS CS Columbia/hackathons/werewolf-hackathon/src/werewolf_agents/cot_sample/dist/chagent-0.1.0-py3-none-any.whl", 
